...
#endif
    GenerateDeuscoins(false, 0, Params());
    StopNode();
    StopTorControl();
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    try {
        ...
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Deuscoin Core is probably already running.") + " %s.", strDataDir, e.what()));
    }
    ...
    GenerateDeuscoins(GetBoolArg("-gen", DEFAULT_GENERATE), GetArg("-genproclimit", DEFAULT_GENERATE_THREADS), chainparams);
