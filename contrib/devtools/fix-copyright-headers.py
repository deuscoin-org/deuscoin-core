...
// Copyright (c) 2009-2012 The Deuscoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Deuscoin/$1-%s The Deuscoin/' %s"
REGEX_CURRENT= re.compile("%s The Deuscoin" % year)
