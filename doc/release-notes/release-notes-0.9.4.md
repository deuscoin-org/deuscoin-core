Deuscoin Core version 0.9.4 is now available from:

  https://deuscoin.org/bin/0.9.4/
...
this update is incompatible with the Deuscoin system and could lead to consensus
forks.

Deuscoin Core released binaries from https://deuscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~deuscoin/+archive/ubuntu/deuscoin
- A third-party or self-compiled Deuscoin Core

upgrade to Deuscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
