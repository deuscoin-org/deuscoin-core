Deuscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/deuscoin/files/Deuscoin/deuscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Deuscoin
...
New/changed settings (command-line or deuscoin.conf file)
--------------------------------------------------------
