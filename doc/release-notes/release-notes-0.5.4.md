Deuscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/deuscoin/files/Deuscoin/deuscoin-0.5.4/
...
http://gitorious.org/deuscoin/deuscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Deuscoin-Qt notifications under Growl 1.3.
Increase required age of Deuscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDeuscoin properly when installing Deuscoin-Qt over it. (Windows)
