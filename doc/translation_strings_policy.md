...
This document provides guidelines for internationalization of the Deuscoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `deuscoin_en.ts` remains unchanged.
