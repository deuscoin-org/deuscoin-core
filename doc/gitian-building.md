...
*Setup instructions for a Gitian build of Deuscoin using a Debian VM or physical system.*
...
- [Building Deuscoin](#building-deuscoin)
...
in the deuscoin repository under 'Fetch and build inputs' to install sources which require
...
To build Deuscoin (for Linux, OS X and Windows) just follow the steps under 'perform
...
DEUSPATH=/some/root/path/deuscoin.git
SIGPATH=/some/root/path/deuscoin-detached-sigs.git
...
[deuscoin/gitian.sigs](https://github.com/deuscoin/gitian.sigs/) repository, or if that's not possible create a pull
